...
class DifferentialExpression(object):
    ...
    def getuserinput(self, analysislocation):
        ...
        print "The text file you need to edit (NOT WITH MICROSOFT WORD) using a text editor like Notepad, is on your Desktop in RNAseq_Data -> date of the current run -> DEanalysis -> conditions_input.txt"
